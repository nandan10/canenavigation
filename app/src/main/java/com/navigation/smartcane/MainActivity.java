            ...
            public void onInit(int status) {
                ...
                if (status == TextToSpeech.SUCCESS) {
                    ...
                    if (!app.hasRefreshed) {
                        ...
                        Toast.makeText(getApplicationContext(),"Welcome to OSM Navi.", Toast.LENGTH_LONG).show();
        ...
        if (endingDestination != null) {
            endingDestination.setOnPlaceSelectedListener(new PlaceSelectionListener() {
                ...
                public void onPlaceSelected(@NonNull Place place) {
                    ...
                    Toast.makeText(getApplicationContext(),"Destination successfully set to " + place.getName(), Toast.LENGTH_LONG).show();
                }
                ...
                public void onError(@NonNull Status status) {
                    ...
                    Toast.makeText(getApplicationContext(),"There was an error setting up the destination. Please try again.", Toast.LENGTH_LONG).show();
                }
            });
        }
                ...
                switch(item.getItemId())
                {
                    ...
                    case R.id.saveroute:
                       // startActivity(new Intent(getApplicationContext(),ShowRoutes.class));
                        ...
                        return true;
                    case R.id.debugbottom:
                        startActivity(new Intent(getApplicationContext(),debugAcitivity.class));
                        overridePendingTransition(0,0);
                        return true;
                }
                return false;
